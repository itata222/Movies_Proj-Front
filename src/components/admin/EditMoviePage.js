                        ...
                        <div className="admin-movies">
                            <div className="admin-movies-desc">
                                <div className="title">
                                    ...
                                    <span>{newTitle || movie.title}</span>
                                    {updateTitle ?
                                        <div>
                                ...
                                <div className="description">
                                    ...
                                    <span>{newDescription || movie.description}</span>
                                    {updateDescription ?
                                        <div>
                                ...
                                <div className="category">
                                    ...
                                    <span>{newCategory || movie.category}</span>
                                    {updateCategory ?
                                        <div>
                                ...
                                <div className="duration">
                                    ...
                                    <span>{newDuration || movie.duration} Minutes</span>
                                    {updateDuration ?
                                        <div>
                            ...
                            <div className="img">
                                <img src={newImageSrc || movie.img} alt="Movie" />
                                {updateImg ?
                                    <div>
